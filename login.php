...
<body>
    <form class="form" method="post" name="login">
        ...
        <i class="fa fa-user" style="font-size: 20px; position: relative; top: 35px; left: 10px; color: lightgray;"></i><input type="text" class="login-input" name="username" style="font-family: 'Ubuntu'; color: #000;" placeholder="Username" autofocus="true"/>
        <i class="fa fa-lock" style="font-size: 20px; position: relative; top: 35px; left: 10px; color: lightgray;"></i><input type="password" class="login-input" name="password" style="font-family: 'Ubuntu'; color: #000;" placeholder="Password"/>
        <center><input type="submit" style="font-family: 'DiscordThin'; float: right;" value="Login" name="submit" class="button"/></center>
