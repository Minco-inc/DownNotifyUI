...
<body>
    <form class="form" action="" method="post">
        ...
        <i class="fa fa-user" style="font-size: 20px; position: relative; top: 35px; left: 10px; color: lightgray;"></i><input type="text" class="login-input" name="username" style="font-family: 'Ubuntu'; color: #000;" placeholder="Username" required />
        ...
        <center><input type="submit" name="submit" style="font-family: 'DiscordThin'; float: right;" value="Register" class="button"></center>
